    ...
    private fun showWriteEepromDialog() {
        ...
        val infoText = TextView(this).apply {
            text = "Detected: ${cellCount}S Configuration\n\n" +
                    ...
                    "ü6”1 Pack Low Voltage Cutoff: ${packUndervoltage / 100.0}V\n" +
                    "ü6”1 Pack Low Voltage Release: ${packUndervoltageRelease / 100.0}V\n\n" +
                    "After 30 seconds, settings will revert to:\n" +
                    "ü6”1 Cell: ${DEFAULT_CELL_UNDERVOLTAGE}V / ${DEFAULT_CELL_UNDERVOLTAGE_RELEASE}V\n" +
                    "ü6”1 Pack: ${defaultPackUndervoltage / 100.0}V / ${defaultPackUndervoltageRelease / 100.0}V\n\n" +
