...
// Full activity with SOC & inlaid Temp gauge (red icon & needle, blue waves), scales SOC~1.4x, Temp~2x
class MeterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tempGauge = TempHalfGauge(this).apply {
            ...
            val size = (min(w, 900) * 0.40f).toInt() // a bit larger footprint since 2x scale internally
        ...
        val root = LinearLayout(this).apply {
            ...
            addView(bannerWarn)
            addView(btnScan)
            // Keep the list tall: put it before gauges and give it weight
    ...
    class TempHalfGauge(context: Context) : View(context) {
        ...
        private val markRed = Paint(Paint.ANTI_ALIAS_FLAG).apply {
            color = Color.parseColor("#DC2626") // hot red
            style = Paint.Style.STROKE
            strokeWidth = 28f
            strokeCap = Paint.Cap.BUTT
        }
